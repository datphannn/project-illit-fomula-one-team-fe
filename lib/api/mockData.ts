...
export const mockDriversDetailed: Driver[] = [
  // 🟠 McLaren
  {
    ...
    description: "McLaren's lead driver and multiple race winner in 2025.",
  },
  {
    id: 'piastri',
    name: 'Oscar Piastri',
    ...
    podiums: 14,
    worldChampionships: 0,
    description: 'Consistent young star supporting McLaren’s title fight.',
  },
  ...
  // 🩵 Mercedes
  {
    ...
    podiums: 35,
    worldChampionships: 0,
    description: "Mercedes' lead driver in the new Antonelli-Russell era.",
  },
  {
    id: 'antonelli',
    name: 'Andrea Kimi Antonelli',
    ...
    podiums: 0,
    worldChampionships: 0,
    description: 'Highly rated Mercedes rookie making his F1 debut in 2025.',
  },
  ...
  // 🔴 Ferrari
  {
    ...
    podiums: 34,
    worldChampionships: 0,
    description: "Ferrari's home-grown star and race winner.",
  },
  {
    id: 'hamilton',
    name: 'Lewis Hamilton',
    ...
    description:
      'Seven-time world champion starting a new chapter with Ferrari.',
  },
  ...
  // 🔵 Red Bull
  {
    ...
    description: 'Defending four-time world champion with Red Bull in 2025.',
  },
  {
    id: 'tsunoda',
    name: 'Yuki Tsunoda',
    ...
    podiums: 1,
    worldChampionships: 0,
    description: 'Promoted to Red Bull Racing for the 2025 season.',
  },
  ...
  // 💙 Williams
  {
    ...
    podiums: 2,
    worldChampionships: 0,
    description: "Williams' lead driver and consistent top-10 finisher.",
  },
  {
    id: 'sainz',
    name: 'Carlos Sainz',
    ...
    podiums: 22,
    worldChampionships: 0,
    description: 'Former Ferrari driver bringing experience to Williams.',
  },
  ...
  // 🟣 RB (Visa Cash App)
  {
    ...
    podiums: 0,
    worldChampionships: 0,
    description: 'RB’s lead driver after Tsunoda’s promotion to Red Bull.',
  },
  {
    id: 'hadjar',
    name: 'Isack Hadjar',
    ...
    podiums: 0,
    worldChampionships: 0,
    description: 'Young French rookie debuting for RB in 2025.',
  },
  ...
  // 🟩 Aston Martin
  {
    ...
    description: 'Veteran leader continuing with Aston Martin.',
  },
  {
    id: 'stroll',
    name: 'Lance Stroll',
    ...
    podiums: 3,
    worldChampionships: 0,
    description: 'Continuing driver partnership at Aston Martin.',
  },
  ...
  // 🟩 Sauber (Stake Kick)
  {
    ...
    podiums: 0,
    worldChampionships: 0,
    description: 'Returning to Sauber for the 2025 season.',
  },
  {
    id: 'bortoleto',
    name: 'Gabriel Bortoleto',
    ...
    podiums: 0,
    worldChampionships: 0,
    description: '2023 F2 champion making his F1 debut with Sauber.',
  },
  ...
  // ⚪ Haas
  {
    ...
    worldChampionships: 0,
    description:
      'Moves to Haas after Alpine, bringing experience and race craft.',
  },
  {
    id: 'bearman',
    name: 'Oliver Bearman',
    ...
    worldChampionships: 0,
    description:
      'Young British driver making his first full F1 season at Haas.',
  },
  ...
  // 💗 Alpine
  {
    ...
    podiums: 3,
    worldChampionships: 0,
    description: 'Alpine’s senior driver in 2025.',
  },
  {
    id: 'colapinto',
    name: 'Franco Colapinto',
    ...
    podiums: 0,
    worldChampionships: 0,
    description: 'Newly promoted F2 driver debuting with Alpine in 2025.',
  },
];
